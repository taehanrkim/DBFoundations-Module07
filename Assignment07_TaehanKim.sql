...
-- 2017-01-01,TaehanKim,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_TaehanKim')
	 Begin 
	  Alter Database [Assignment07DB_TaehanKim] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_TaehanKim;
	 End
	Create Database Assignment07DB_TaehanKim;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_TaehanKim;
